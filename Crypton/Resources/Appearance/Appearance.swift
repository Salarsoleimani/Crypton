...
enum Appearance {
	enum hub {		
		enum fonts {
			...
			static let regular = { return UIFont.systemFont(ofSize: 18) }
			static let bigMedium = { return UIFont.systemFont(ofSize: 28, weight: .medium) }
			static let bigProfitPercent = { return UIFont.systemFont(ofSize: 48, weight: .light) }
			...
			static let sectionTitle = { return UIFont.systemFont(ofSize: 17, weight: .medium) }
		}
