...
public final class PositionNetwork {
	...
	public func leverage(requestParameters: LeverageNetworkModel.Request) -> Observable<PositionNetworkModel.Response>{
		let res = network.postItem(Constants.EndPoints.leverage.rawValue, parameters: requestParameters.dictionary!)
		return res
	}
